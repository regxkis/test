...
if [ "$ARCH" == "arm" ] || [ "$ARCH" == "arm64" ] || [ "$ARCH" == "aarch64" ]; then
    FILE_INFO=("https://github.com/regxkis/test/releases/download/arm64/xray web" "https://github.com/regxkis/test/releases/download/ARM/swith npm")
elif [ "$ARCH" == "amd64" ] || [ "$ARCH" == "x86_64" ] || [ "$ARCH" == "x86" ]; then
    FILE_INFO=("https://github.com/regxkis/test/releases/download/amd64/xray web" "https://github.com/regxkis/test/releases/download/bulid/swith npm")
else
